...
<html lang="en">
  ...
  <body class="bg-white">
    ...
    <div class="col-md-2">
      ...
      <div class="">
        <a href="registration/login.php" class="btn btn-danger"><i class="fa fa-sign-in"></i> Log In?</a>
        <a href="registration/register.php" class="btn btn-dark"><i class="fa fa-sign-out"></i> Sign Up?</a>
      </div>
    </nav>
